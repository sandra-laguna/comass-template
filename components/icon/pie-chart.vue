<template>
  <svg
    ...
    style="enable-background: new 0 0 489.1 489.1"
    xml:space="preserve"
  >
    <path
      d="M12.25,215.7h191.2c6.8,0,12.3-5.5,12.3-12.3V12.3c0-6.8-5.5-12.3-12.3-12.3C91.25,0,0.05,91.2,0.05,203.4
			C0.05,210.3,5.55,215.7,12.25,215.7z M191.15,25v166.2H24.95C30.95,102.3,102.25,31,191.15,25z"
    />
    <path
      d="M44.45,266.8c0,122.6,99.7,222.3,222.3,222.3s222.3-99.7,222.3-222.3s-99.7-222.3-222.3-222.3c-6.8,0-12.3,5.5-12.3,12.3
